...
class AIAssistantOpenAIClasses(override val properties: Properties) : AIAssistant {
    ...
    override fun buildRequest(prompt: String): Request {
        // Create request structure using data classes, passing the dynamic configuration values.
        val messages = listOf(
        ...
        val openAIRequest = OpenAIRequest(
            ...
            max_tokens = maxTokens     // Sourced from AIAssistant.maxTokens -> config.properties MAX_TOKENS
        )
